...
//data class MP3File(val title: String, val artist: String, val filePath: String, val duration: Long)

import android.os.Parcel
import android.os.Parcelable

//data class MP3File(val title: String, val artist: String, val filePath: String, val duration: Int) : Parcelable {
